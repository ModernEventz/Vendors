...
import { getVendorDetailsById, insertVendors, updateVendors } from '@/lib/actions/vendor.action';
  ...
  async function uploadImage(e) {
    ...
    const form = useForm<z.infer<typeof eventFormSchema>>({
      ...
      async function onSubmit(values: z.infer<typeof eventFormSchema>) {
        ...
        const { data, error } = await updateVendors({vendorId:params.id, title:values.title,location:values.location,price:values.price,description:values.description,category:values.categoryId,publicUrls})
