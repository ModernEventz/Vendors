...
const MarkAsHired = ({vendor_id,vendor_name,location,price,rating,rating_count,description,image,profile_id,category}) => {
  ...
  const handleSubmitClick = async () => {
     ...
     const  {  error } =  await submitHiredVendor({vendor_id,vendor_name,location,price,rating,rating_count,description,image,profile_id,category})
